...
it("Should clean the name", () => {
  const inputValues = [
    ...
    {
      raw: " factura     1  2  3.p df     ",
      expected: "factura123.pdf",
    },
    {
      raw: "   factura 123 . pdf",
      expected: "factura123.pdf",
...
it("Get invoice number", () => {
  const inputValues = [
    ...
    {
      raw: "Factura 09012.pdf",
      expected: "09012",
    },
  ];
    inputValues.forEach(input => {
        actual = getInvoiceNumber(input.raw);
        expect(actual).toBe(input.expected);
    });
  ...
  const inputValues = [
    {
      ...
      expected: new Row("1.00", "DOCETAXEL KEMEX 80 MG"),
    },
    {
      raw: "2Bien1.00 Uni300.000300.00IVA: 32.14DOCETAXEL KEMEX 20 MG",
      expected: new Row("1.00", "DOCETAXEL KEMEX 20 MG"),
    },
    {
      raw: "1Bien206.00 Uni178.50036,771.00IVA: 3,939.75OXALIPLATINO 100 MG",
      expected: new Row("206.00", "OXALIPLATINO 100 MG"),
    },
  ];
